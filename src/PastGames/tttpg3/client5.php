    ...
    <div class="topDiv">
        ...
        <div class="container" id="container">
            ...
            <div class="sidebar" id="sidebar">
                ...
                <div class="flex-col2">
                    <button class="connectBtn" onclick="window.location.href = 'client4.php';">Previous</button>
                    <button class="newGame" onclick="window.location.href = 'client6.php';">Next</button>
                </div>
            ...
            <div class="mainbar" id="mainbar">
                ...
                <div class="board" id="board">
                    <div class="cell circle" id="cell">X</div>
                    <div class="cell x" id="cell"></div>
                    <div class="cell x" id="cell"></div>
