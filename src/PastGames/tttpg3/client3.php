    ...
    <div class="topDiv">
        ...
        <div class="container" id="container">
            ...
            <div class="sidebar" id="sidebar">
                ...
                <div class="flex-col2">
                    <button class="connectBtn" onclick="window.location.href = 'client2.php';">Previous</button>
                    <button class="newGame" onclick="window.location.href = 'client4.php';">Next</button>
                </div>
