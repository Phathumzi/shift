    ...
    <div class="topDiv">
        ...
        <div class="container" id="container">
            ...
            <div class="sidebar" id="sidebar">
                ...
                <div class="flex-col2">
                    <button class="connectBtn" onclick="window.location.href = 'client3.php';">Previous</button>
                    <button class="newGame" onclick="window.location.href = 'client5.php';">Next</button>
                </div>
